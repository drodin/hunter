...
C:\msys64\usr\bin\wget.exe https://github.com/drodin/polly/archive/refs/heads/pr.new_toolchains.zip
7z x pr.new_toolchains.zip
set POLLY_ROOT=%cd%\polly-pr.new_toolchains
